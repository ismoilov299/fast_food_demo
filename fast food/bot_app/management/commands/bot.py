    ...
    if data_sp[0] == globals.KORZINKA:
        if data_sp[1] == "select":
            if context.user_data.get("carts", {}):
                ...
                query.message.reply_text(text=globals.NO_ZAKAZ[db_user['lang_id']])
...
def location_handler(update, context):
    ...
    def create_incoming_order(product_id, phone,count):
        url = 'https://joinposter.com/api/incomingOrders.createIncomingOrder?token=398603:68145821aacbd96c265afe76f2dadb2e'
    ...
    create_incoming_order(product_id=product['p_id'],phone=db_user['phone_number'],count=val)
